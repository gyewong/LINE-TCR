...
cl = LINETCR.LINE()
cl.login(token="EpiOSh3x1xHdakRNpUv6.scbep2C8hggV82zKaeGizG.273qO/HkGQgixiqXTQkG8qQS50py5Xhq/RisxkbJHEk=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EpHuQXzycbQbZZD2uwR7.TqW/sCzbwO+FPsMD5Kz+fW.Tz/XcXwVpBZ4CvvaoyUtrEmYGsCynZXpO2irxHqxaaU=")
ki.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="EphLTWD9ucQxEYVYmNu9.KzP9kSTyEseLnzLV/gJzsq.hNa32tB0iI2QSiV9V+Gv7+ZqrBdjxulzb1Ho7xKvWE4=")
ki2.loginResult()
...
owner =["u4820443f673c1c61aff3666400480866"]
admin = ["u4820443f673c1c61aff3666400480866"]
wait = {
    'contact':False,
    'autoJoin':True,
